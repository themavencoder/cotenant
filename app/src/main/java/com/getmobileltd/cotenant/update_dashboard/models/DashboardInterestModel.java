...
public class DashboardInterestModel {
    ...
    public DashboardInterestModel(String bedroom, String stateLocation, String addressLocation, String rent, int imageOfLocation) {
